  ...
  return (
    <section className="container mx-auto py-10 px-4">
      <div className="flex flex-col">
        <h1 className="text-4xl font-extrabold text-center mb-8">Kurtas</h1>
      ...
      <div className="grid lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 gap-8 px-4 py-20">
        {[...Array(8)].map((item) => (
          <Link href="/categories/kurtas/[id]slug?1">
            <div
              key={item}
